...
const radio = {
    ...
    "efkarlı": "http://www.radyodinle.fm/#best-fm-98-4"
      ...
      if (!args) return msg.channel.send(':x: | Bir Radyo Seçin : **franceinfo**, **efkarlı**, **rtl2**, **skyrock**, **rtl**, **rfm**, **bfm**')
        ...
        if(!radio[args]) return msg.channel.send(':x: | Lütfen Yandaki Radyolardan Birini Seç : **franceinfo**, **efkarlı**, **rtl2**, **skyrock**, **rtl**, **rfm**, **bfm**')
...
exports.help = {
    name : "radyo",
    usage: "radyo <radyo ismi>",
    description: "Radyoyu açar."
}