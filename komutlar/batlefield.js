...
exports.run = async (bot, message, args) => {
    ...
    if (args.length < 1) {
        return message.channel.send("Kullanım: r!battlefield <kullanıcıadı> <XBOX/PS4/PC>")
    }
...
exports.help = {
  name: 'battlefield',
  description: 'Battlefield İstatistiklerinizi Gösterir. ',
  usage: 'r!batlefield [kullanıcı] [sebep]'
};