...
if (mention != null || mention != undefined) {
  ...
  .addField('İşte avatar!', `[Avatarın büyük halini göster!](${mention.avatarURL})`, false);
  message.react("����");
  ...
  .addField('İşte avatar!', `[Avatarın büyük halini göster!](${message.author.avatarURL})`, false);
  console.log("r!avatar komutu " + message.author.username + '#' + message.author.discriminator + " tarafından kullanıldı.")
